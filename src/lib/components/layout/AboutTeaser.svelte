...
<script lang="ts">
  ...
  name: "George Eliadis",
  role: "Founder & CEO",
  image: "/generated/image-a-confident-male-founder-in-his-30s-with.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"The idea came from one question: Why are we still leaving thousands of dollars on the table because of one dispatching decision? I knew we could fix that."`}
    />
